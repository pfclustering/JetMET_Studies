...
# with command line options: step3 --conditions auto:phase1_2017_realistic --pileup_input das:/RelValMinBias_13/CMSSW_10_6_1-106X_mc2017_realistic_v6-v1/GEN-SIM -n 10 --era Run2_2017 --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --pileup AVE_35_BX_25ns --geometry DB:Extended --io RecoFullPU_2017PU.io --python RecoFullPU_2017PU.py --conditions=106X_mc2017_realistic_v6 --no_exec --filein file:step2.root --fileout file:step3.root --nThreads 8
